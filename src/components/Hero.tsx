...
import ThreeScene from './ThreeScene'; // Assuming this is a background element
...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden py-20 md:py-0">
      ...
      {/* Background Scene: Positioned absolutely to not affect layout */}
      <ThreeScene />
      ...
      {/* FIX: Added `hidden lg:flex`. It now only appears on large screens where there's no overlap. */}
      <motion.div 
